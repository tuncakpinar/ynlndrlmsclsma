...
?>
<?php 
	$uye=$ifo->sec('*','uyeler','id='.$_SESSION['id'])->oku();
?>
		...
		<div class="col-md-6">
			...
			<div class="form-group col-lg-12">
				<div class="input-group">
					...
					<input name="adi" type="text" placeholder="Ad Soyad" required class="form-control input-lg" maxlength="60" value="<?=$uye['adi']?>"/>
				</div>
			</div>
			...
			<div class="form-group col-lg-12">
				<div class="input-group">
					...
					<input name="email" type="email" placeholder="Email" required class="form-control input-lg" maxlength="60" value="<?=$uye['email']?>"/>
				</div>
			</div>
			<div class="form-group col-lg-12" >
